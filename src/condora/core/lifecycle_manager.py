...
from condora.adapters.base import CondorAdapter
from condora.config import Settings
from condora.db.repository import Repository
from condora.models.dag import wu_names
...
def _compute_adaptive_params(config, dag, workflow, new_metrics, settings):
    ...
    try:
        from condora.core.adaptive import compute_round_optimization
    except ImportError:
        logger.warning("condora.core.adaptive not available — skipping optimization")
        return None
...
class RequestLifecycleManager:
    ...
    def _build_workers(self, repo: Repository):
        ...
        from condora.adapters.mock import MockDBSAdapter
    ...
    async def _handle_active(self, request):
        ...
        if self.output_manager:
            from condora.core.output_manager import RucioRegistrationError
            try:
