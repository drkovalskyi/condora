...
Provides:
- write_pilot_script(path) — writes the standalone condora_pilot.py to disk
...
def write_pilot_script(path: str) -> None:
    """Write the standalone condora_pilot.py script to disk.
    ...
    script = textwrap.dedent('''\
        #!/usr/bin/env python3
        """condora_pilot.py — Per-step CMSSW pilot with watchdog.
        ...
        def main():
            parser = argparse.ArgumentParser(description="Condora pilot smoke test")
