#!/usr/bin/env python3
"""Condora cmsRun Simulator — produces identical artifacts to real cmsRun in seconds.

Standalone script (no Condora imports). Included in sandbox tarball, runs inside
...
def write_fjr_xml(
    ...
    """Write a FrameworkJobReport XML file compatible with all Condora parsers.
...
def main():
    parser = argparse.ArgumentParser(description="Condora cmsRun Simulator")
    parser.add_argument(
