...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str = ""  # Set via CONDORA_DATABASE_URL env var or .env file
    db_pool_size: int = 10
    ...
    # DAG submission
    submit_base_dir: str = "/mnt/shared/tmp/condora"
