...
from condora import __version__
...
from condora.core.monitoring_collector import MonitoringCache, run_monitoring_collector
...
def _build_adapters(settings: Settings):
    ...
    if proxy:
        ...
        from condora.adapters.cric import CRICClient
...
async def lifespan(app: FastAPI):
    ...
    logger.info("Condora v%s started", __version__)
...
def create_app() -> FastAPI:
    ...
    # Web UI
    from condora.ui.routes import ui_router
