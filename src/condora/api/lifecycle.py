...
EDITABLE_FIELDS = {
    ...
    "proc_retry_count": (int, lambda v: v >= 0),
    "wu_retry_count": (int, lambda v: v >= 0),
...
async def lifecycle_settings(request: Request):
    ...
    return {
        ...
        "proc_retry_count": s.proc_retry_count,
        "wu_retry_count": s.wu_retry_count,
...
async def restart_lifecycle(request: Request):
    ...
    from condora.main import _make_task_watchdog
