...
document.addEventListener('alpine:init', () => {
    Alpine.data('settingsPage', () => ({
        ...
        async fetchAll() {
            try {
                ...
                const [settings, status] = await Promise.all([
                    CONDORA_API.getLifecycleSettings(),
        ...
        async doSave() {
            ...
            this.saving = true;
            try {
                await CONDORA_API.updateSettings(changes);
                this.toast('success', 'Settings saved, restarting lifecycle manager...');
                await CONDORA_API.restartLifecycle();
                this.editing = false;
                this.editValues = {};
                await this.fetchAll();
        ...
        async doRestart() {
            ...
            try {
                const result = await CONDORA_API.restartLifecycle();
