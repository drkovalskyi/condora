...
class HTCondorAdapter(CondorAdapter):
    ...
    def _query_dag_jobs_sync(self, cluster_id: str,
        ...
        projection = [
            ...
            "CONDORA_CurrentStep", "CONDORA_NumSteps", "CONDORA_StepDone",
            "CONDORA_StepName", "CONDORA_StepWallSec",
            "CONDORA_Phase", "CONDORA_StageoutStart",
        ]
        ads = schedd.query(constraint=constraint, projection=projection)
        ...
        for ad in ads:
            ...
            job = {
                ...
                "current_step": ad.get("CONDORA_CurrentStep"),
                "num_steps": ad.get("CONDORA_NumSteps"),
                "step_done": ad.get("CONDORA_StepDone"),
                "step_name": str(ad.get("CONDORA_StepName", "")).strip('"') or None,
                "phase": str(ad.get("CONDORA_Phase", "")).strip('"') or None,
                "stageout_start": ad.get("CONDORA_StageoutStart"),
            }
            if status_int == 5:
